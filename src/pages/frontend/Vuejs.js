    ...
    return (
        <>
            ...
            <Container disableGutters maxWidth="xl">
                <Grid container sx={{ height: "400px", backgroundImage: `url(${vuejs})`, bgcolor: 'rgb(90,90,90)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundBlendMode: "multiply", backgroundPosition: 'center' }}>
