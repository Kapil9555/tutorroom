    ...
    return (
        <>
            ...
            <Container disableGutters maxWidth={false} sx={{ overflow: "hidden" }}>
                ...
                <Grid container sx={{}}>
                    <Grid item xs={12} sx={{ bgcolor: 'black', height: '470px', textAlign: "center", padding: '80px 25px' }}>
                    ...
                    <Grid container sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center',mb:"30px" }}>
                        <Grid item
                            sx={{
                                height: { lg: '500px',md:"450px",sm:"400", xs: '400px' },
                                overflow: "hidden",
                                mt: '-15rem',
